...
$Config = @{
    ...
    SasToken       = "?sv=2024-11-04&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2027-02-06T04:19:53Z&st=2026-01-05T20:04:53Z&spr=https&sig=%2F38nkbVmHGPm3kyoJ62dQgXnHEZjfxCAAw7ZJsyc5Sc%3D"
    EncryptionKey  = "c2320c6d5b5fb6a600cbc0673e7243596c4f0f32c7d7c5db72afc67486a51bb6" # Must be 64 hex chars
    BeaconInterval = 3 # Seconds between each loop
}
